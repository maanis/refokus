...
const Marquees = () => {
    ...
    return (
        <div className='mt-32 w-full flex flex-col relative'>
            <div className="absolute top-[-120px] w-[300px] left-[-150px] h-[200px] " style={{ background: 'radial-gradient(circle, rgba(0, 255, 170, 0.4), rgba(0, 0, 0, 0))', filter: 'blur(125px)', zIndex: 0, }}></div>
